...
function createOne(group) {
  ...
  append('name', group['J-Group Name']);
  ...
  /*<select name="type_id">
   <option value="1">J-Groups</option>		
   ...
   */
  append('udf_group_pulldown_1_id', categoryToID(group['J-Group Category']));
   ...
   */
  append('udf_group_pulldown_2_id', forToID(group['Who is your J-Group for?']));
  ...
  function dateToID(date) {
    switch (date) {
      ...
      case '7/9, 7/16, 7/23, 7/30, 8/6':
        return '7';
      case 'Regular discussion J-Group meetings will be held each Sunday from 4:00pm - 6:30pm, with optional activity groups for viewing/discussing of current summer movies & blockbusters at local movie theaters every Friday night.':
      ...
      case 'We will meet every Tuesday night at a local park.  We will learn what The Journey has to offer, and what we can offer ':
